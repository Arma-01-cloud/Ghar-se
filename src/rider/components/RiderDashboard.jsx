    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white rounded-3xl p-6 border border-stone-200 shadow-xs">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="py-2.5 px-4 bg-emerald-800 hover:bg-emerald-900 text-white font-extrabold text-xs rounded-xl shadow-md transition-colors flex items-center gap-1"
          >
            <span>₹{earnings.today} Today</span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-stone-200 space-y-1 shadow-2xs">
          ...
          <p className="font-display font-black text-2xl text-stone-900">{earnings.todayDeliveries}</p>
        </div>

        <div className="bg-white p-4 rounded-2xl border border-stone-200 space-y-1 shadow-2xs">
          <span className="text-[10px] font-extrabold uppercase tracking-wider text-stone-400">Today's Earnings</span>
          <p className="font-display font-black text-2xl text-emerald-950">₹{earnings.today}</p>
        </div>

        <div className="bg-white p-4 rounded-2xl border border-stone-200 space-y-1 shadow-2xs">
          <span className="text-[10px] font-extrabold uppercase tracking-wider text-stone-400">Distance Covered</span>
          <p className="font-display font-black text-xl text-stone-900">{earnings.todayDistanceKm} km</p>
        </div>
