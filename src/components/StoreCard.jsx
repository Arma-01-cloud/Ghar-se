...
import { Star, MapPin, Clock, Heart, Store, ChevronRight } from 'lucide-react';
      ...
      <div className="space-y-2">
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex items-center gap-1 bg-amber-50 text-amber-900 font-extrabold text-xs px-2 py-0.5 rounded-md shrink-0">
            ...
            <span className="text-stone-400 font-normal text-[11px]">({store.reviews})</span>
          </div>
        </div>

        <div className="flex items-center gap-3 text-xs font-semibold text-stone-500">
          <span className="flex items-center gap-1">
            <MapPin className="w-3.5 h-3.5 text-emerald-700" /> {store.distance} km away
          </span>
          <span>•</span>
          <span className="flex items-center gap-1">
            <Clock className="w-3.5 h-3.5 text-emerald-700" /> {store.deliveryTime}
          </span>
        </div>
