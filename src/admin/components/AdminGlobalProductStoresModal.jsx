...
import { 
  ...
  Package, AlertCircle, CheckCircle2, RefreshCw, Layers, ShieldCheck
} from 'lucide-react';
...
export default function AdminGlobalProductStoresModal({ product, onClose, onUpdated }) {
  ...
  // New Store Assignment Form State
  ...
  // Filter available shops that don't already carry this product
  ...
  // Start Editing a Store-Specific Row
    ...
    <div className="fixed inset-0 z-50 bg-stone-950/70 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 overflow-y-auto animate-fade-in">
      <div className="bg-white w-full max-w-4xl rounded-3xl shadow-2xl border border-stone-200 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="p-4 sm:p-6 space-y-6 overflow-y-auto flex-1 bg-[#FBF9F5]">
          ...
          {/* STATS OVERVIEW FOR THIS PRODUCT */}
          ...
          {/* STORES CURRENTLY CARRYING THIS PRODUCT TABLE */}
          <div className="bg-white rounded-3xl border border-stone-200 shadow-xs overflow-hidden">
            ...
            {isLoading ? (
              ...
              <div className="p-8 text-center space-y-2">
                ...
                <p className="text-[11px] text-stone-400">Use the form below to assign this product to a store with custom price and stock.</p>
              </div>
            ) : (
                          ...
                          <td className="p-3.5 font-extrabold text-stone-900">
                            <div>
                              ...
                              <span className="text-[10px] text-stone-400 font-medium">
                                {item.locality || item.city} {item.storePhone ? `• ${item.storePhone}` : ''}
                              </span>
                            </div>
                          </td>
                          ...
                          <td className="p-3.5">
                            {isEditing ? (
                              <input 
                                ...
                                className="w-20 px-2 py-1 bg-white border border-emerald-400 rounded-lg text-xs font-bold focus:outline-hidden focus:ring-1 focus:ring-emerald-700"
                              />
                            ) : (
                          ...
                          <td className="p-3.5">
                            {isEditing ? (
                              <input 
                                ...
                                className="w-16 px-2 py-1 bg-white border border-emerald-400 rounded-lg text-xs font-bold focus:outline-hidden focus:ring-1 focus:ring-emerald-700"
                              />
                            ) : (
          ...
          {/* ASSIGN PRODUCT TO ANOTHER STORE FORM */}
              ...
              <form onSubmit={handleAssignNewStore} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  ...
                  <div className="space-y-1 sm:col-span-2 lg:col-span-1">
                    <label className="text-[11px] font-extrabold text-stone-600 uppercase tracking-wider block">
                      Target Store *
                    </label>
                    <select
                      ...
                      required
                      className="w-full px-3 py-2.5 bg-stone-50 border border-stone-300 rounded-xl text-xs font-bold text-stone-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-700/20 focus:border-emerald-700"
                    >
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 bg-stone-50 border border-stone-300 rounded-xl text-xs font-mono text-stone-900 focus:outline-hidden focus:ring-2 focus:ring-emerald-700/20 focus:border-emerald-700"
                    />
                  </div>

                  {/* AVAILABILITY TOGGLE & SUBMIT BUTTON */}
                  <div className="flex items-end justify-between gap-3 sm:col-span-2 lg:col-span-1">
                    ...
                    <button
                      ...
                      className="px-5 py-2.5 bg-emerald-800 hover:bg-emerald-900 text-white font-extrabold text-xs rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                    >
                      <Plus className="w-4 h-4" />
                      <span>{isAssigning ? 'Assigning...' : 'Assign to Store'}</span>
                    </button>
                  </div>
        ...
        <div className="p-4 bg-white border-t border-stone-200 flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-xs text-stone-400 font-semibold">
            ...
            <span>Single Global Identity • Multi-Store Pricing & Inventory Isolation</span>
          </div>
          <button
            onClick={onClose}
