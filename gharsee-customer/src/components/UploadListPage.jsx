...
import {
  ...
  Store, MessageSquare, Plus, Minus
} from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-4 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        {availableStores && availableStores.length > 1 && (
          <div className="w-full sm:w-auto flex items-center gap-2">
            <label htmlFor="store-select-cust" className="text-xs font-bold text-stone-500 hidden sm:inline">
              Switch:
            </label>
            <select
              id="store-select-cust"
      ...
      <div className="bg-white rounded-3xl border border-stone-200 p-6 sm:p-8 shadow-sm space-y-6">
        ...
        <div className="space-y-4 pt-4 border-t border-stone-200">
          ...
          <div className="space-y-1.5">
            <label htmlFor="order-note-cust" className="font-extrabold text-sm text-stone-900 block">
              Optional Note
            </label>
            <textarea
              id="order-note-cust"
